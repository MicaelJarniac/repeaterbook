...
from repeaterbook.mcp.models import write_schema


def test_write_schema_console_script_registered() -> None:
    """`repeaterbook-write-schema` resolves to models.write_schema."""
    ...
    assert ep.value == "repeaterbook.mcp.models:write_schema"
